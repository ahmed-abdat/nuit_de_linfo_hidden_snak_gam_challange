...
const FallingText: React.FC<FallingTextProps> = ({
  ...
  // Initialize based on trigger to avoid setState in effect for 'auto'
  ...
  useEffect(() => {
    // 'auto' is handled by initial state
  ...
  useEffect(() => {
    ...
    const updateLoop = () => {
      // Only update DOM positions - Runner.run() already advances the physics engine
