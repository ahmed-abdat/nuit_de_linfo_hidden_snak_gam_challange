  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 h-full">
        ...
        <div className="md:col-span-3 flex flex-row md:flex-col justify-between items-center md:items-start order-2 md:order-1">
            ...
            {thumbnailReviews.map((review) => {
              ...
              return (
                <button
                  ...
                  className="overflow-hidden rounded-md w-12 h-14 sm:w-14 sm:h-16 md:w-16 md:h-20 opacity-70 hover:opacity-100 transition-opacity duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
        ...
        <div className="md:col-span-5 flex flex-col justify-between md:pl-6 order-3 md:order-3">
          {/* Text Content */}
          <div className="relative overflow-hidden pt-2 md:pt-12 min-h-[140px] md:min-h-[200px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                ...
                <blockquote className="mt-3 md:mt-6 text-base sm:text-xl md:text-2xl font-medium leading-snug">
          ...
          <div className="flex items-center space-x-2 mt-4 md:mt-0">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-10 h-10 md:w-12 md:h-12 border-muted-foreground/50"
              onClick={handlePrev}
            ...
            <Button
              variant="default"
              size="icon"
              className="rounded-full w-10 h-10 md:w-12 md:h-12 bg-primary text-primary-foreground hover:bg-primary/90"
              onClick={handleNext}
